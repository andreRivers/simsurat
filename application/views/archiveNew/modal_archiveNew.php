            ...
            <div class="modal-body">
                <form method="POST" action="<?= base_url('archiveNew/view') ?>">
                    ...
                    <div class="form-group">
                        ...
                        <small class="text-danger pl-2">- Contoh Pengisian : /KEP/II.3-AU/UMSU-01/D/2021 (Sesuaikan Dengan masing-masing Format ) </small>
                    </div>
                    <div class="form-group">
...
<!-- KIRIM SURAT -->
<?php
$users = "SELECT * From app_user where role_id < 4";
